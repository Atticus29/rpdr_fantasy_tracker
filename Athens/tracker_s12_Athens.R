...
baseDir = "/Users/mf/Desktop/rpdr_fantasy_tracker/Athens/"


##########
##Week 3##
##########
fileName = "1_Athens_RPDR_S12_StartingSheet.csv"
...
# ##########
# 
fileName = "4_ep_Athens_RPDR_S12.csv"
revisedFileName = sub('\\.csv','', fileName)
data = read.csv(file = paste0(baseDir, fileName), header=T, sep=",", stringsAsFactors = FALSE)
...
fileName = "5_ep_Athens_RPDR_S12.csv"
revisedFileName = sub('\\.csv','', fileName)
data = read.csv(file = paste0(baseDir, fileName), header=T, sep=",", stringsAsFactors = FALSE)
...
colnames(scoreTable) = currentData[,2]
x = barplot(scoreTable,ylab="Score",xaxt="n", las=2, col=darkcols)
text(cex=1, x=x, y=-2.4, currentData[,2], xpd=TRUE, srt=90)
...
fileName = "6_ep_Athens_RPDR_S12.csv"
revisedFileName = sub('\\.csv','', fileName)
data = read.csv(file = paste0(baseDir, fileName), header=T, sep=",", stringsAsFactors = FALSE)
...
darkcols <- colorRampFunction(nrow(data)*2)
# table(wk1Scores,wk2Scores)
scoreTable = rbind(wk3Scores, wk4Scores, wk5Scores, wk6Scores, wk7Scores)
colnames(scoreTable) = currentData[,2]
...
fileName = "7_ep_Athens_RPDR_S12 - 2_Athens_RPDR_S12.csv"
revisedFileName = sub('\\.csv','', fileName)
data = read.csv(file = paste0(baseDir, fileName), header=T, sep=",", stringsAsFactors = FALSE)
...
fileName = "8_ep_Athens_RPDR_S12 - 2_Athens_RPDR_S12.csv"
revisedFileName = sub('\\.csv','', fileName)
data = read.csv(file = paste0(baseDir, fileName), header=T, sep=",", stringsAsFactors = FALSE)
...
fileName = "9_ep_Athens_RPDR_S12 - 2_Athens_RPDR_S12.csv"
revisedFileName = sub('\\.csv','', fileName)
data = read.csv(file = paste0(baseDir, fileName), header=T, sep=",", stringsAsFactors = FALSE)
...
text(cex=1, x=x, y=-6.1, currentData[,2], xpd=TRUE, srt=90)
...
fileName = "10_ep_Athens_RPDR_S12 - 2_Athens_RPDR_S12.csv"
revisedFileName = sub('\\.csv','', fileName)
data = read.csv(file = paste0(baseDir, fileName), header=T, sep=",", stringsAsFactors = FALSE)

currentData = data
currentScores = c(rep(0,nrow(currentData)))
tops = c("Gigi Goode", "Jaida Essence Hall", "Sherry Pie")
isThereATie = FALSE
isThereADoubleSave = FALSE
howManyPeopleTied =1

bottoms = c("Jackie Cox", "Crystal Methyd")
...
scoreTable = rbind(wk3Scores, wk4Scores, wk5Scores, wk6Scores, wk7Scores, wk8Scores, wk9Scores, wk10Scores, wk11Scores, wk12Scores)
colnames(scoreTable) = currentData[,2]
x = barplot(scoreTable,ylab="Score",xaxt="n", las=2, col=darkcols, ylim=c(0,50))
